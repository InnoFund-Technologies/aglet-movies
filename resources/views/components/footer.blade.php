<footer class="bg-blue-100/80 font-sans dark:bg-gray-900">
    <div class="container px-6 py-12 mx-auto">
        <div class="grid grid-cols-1 gap-6 sm:grid-cols-2 sm:gap-y-10 lg:grid-cols-4">
            <div class="sm:col-span-2">
                ...
                <div class="flex flex-col mx-auto mt-6 space-y-3 md:space-y-0 md:flex-row">
                    <input id="email" type="text" class="px-4 py-2.5 text-gray-700 rounded-lg bg-gray-700 border-gray-600 focus:border-blue-400 focus:outline-none focus:ring focus:ring-opacity-40 focus:ring-blue-300" placeholder="Email Address" />
            ...
            <div>
                ...
                <div class="flex flex-col items-start mt-5 space-y-2">
                    ...
                    <a href="{{ route('contact.show') }}" class="transition-colors duration-300 text-gray-300 hover:text-blue-400 hover:underline hover:cursor-pointer">Contact</a>
                </div>
            </div>
        ...
        <p class="font-sans p-8 text-start md:text-center md:text-lg md:p-4">© 2025 Aglet Movies Inc. All rights reserved.</p>
    </div>
</footer>