                    ...
                    <form class="mt-8 space-y-6">
                        <div>
                            ...
                            <div class="relative flex items-center">
                                <input name="email" id="email" type="text" required class="w-full rounded-lg py-3 px-4 bg-gray-600 text-gray-100 border-none outline-0 text-sm inset ring-1 ring-gray-600 focus:ring-[#FF2D20] hover:ring-[#FF2D20]" placeholder="Enter email" />
                        ...
                        <div>
                            ...
                            <div class="relative flex items-center">
                                <input name="password" id="password" type="password" required class="w-full rounded-lg py-3 px-4 bg-gray-600 text-gray-100 border-none outline-0 text-sm inset ring-1 ring-gray-600 focus:ring-[#FF2D20] hover:ring-[#FF2D20]" placeholder="Enter password" />
                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="w-4 h-4 text-gray-300 absolute right-4 cursor-pointer">
                        ...
                        <div class="!mt-8">
                            <button type="button" class="w-full py-3 px-4 text-sm tracking-wide rounded-lg text-white bg-[#FF2D20] hover:bg-[#FF2D20] focus:outline-none">
                                Login
                            </button>
                        </div>
